...
const About: React.FC = () => {
  return (
    <>
      <SEO
        title="About Screen Sips - AI-Powered Drinking Game Generator"
        description="Learn about Screen Sips, the AI-powered platform that creates hilarious drinking games and themed cocktails for your favorite movies and TV shows."
        keywords="about Screen Sips, AI drinking games, entertainment platform, movie night games, party games, drinking game generator"
        url="/about"
      />
