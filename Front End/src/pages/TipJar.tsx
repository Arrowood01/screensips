...
const TipJar: React.FC = () => {
  return (
    <>
      <SEO
        title="Support Screen Sips - Tip Jar & Donations"
        description="Support Screen Sips and help us create more amazing drinking games and themed cocktails. Every contribution keeps the party going!"
        keywords="support Screen Sips, tip jar, donations, drinking games, AI entertainment, movie night games"
        url="/tip"
      />
